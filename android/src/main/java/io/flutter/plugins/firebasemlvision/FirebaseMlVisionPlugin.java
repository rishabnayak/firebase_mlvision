...
public class FirebaseMlVisionPlugin implements MethodCallHandler {
  ...
  private FirebaseMlVisionPlugin(Registrar registrar, FlutterView view) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new FirebaseMlVisionPlugin(registrar, registrar.view()));
  }
  ...
  private class Camera {
    ...
    private void registerEventChannel() {
      new EventChannel(
              registrar.messenger(), "plugins.flutter.io/firebase_mlvision" + textureEntry.id())
              .setStreamHandler(
